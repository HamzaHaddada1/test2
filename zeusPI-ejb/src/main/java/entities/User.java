...
public class User implements Serializable {
	...
	@OneToMany(mappedBy = "friendsent",orphanRemoval=true,cascade={CascadeType.PERSIST,CascadeType.ALL},fetch=FetchType.EAGER)
	private List<Friend> friendsents;
    @OneToMany(mappedBy="friendreciver",orphanRemoval=true,cascade={CascadeType.PERSIST,CascadeType.ALL},fetch=FetchType.EAGER)
	private List<Friend> friendrecivers;
    @OneToMany(mappedBy="user",orphanRemoval=true,cascade={CascadeType.PERSIST,CascadeType.ALL},fetch=FetchType.EAGER)
    private List<Education> educations;
    @OneToMany(mappedBy="user",orphanRemoval=true,cascade={CascadeType.PERSIST,CascadeType.ALL},fetch=FetchType.EAGER)
    private List<certification> certifications;
	@OneToMany(mappedBy = "Vieweruser",orphanRemoval=true,cascade={CascadeType.PERSIST,CascadeType.ALL},fetch=FetchType.EAGER)
	private List<View> viewerusers;
    @OneToMany(mappedBy="Vieweduser",orphanRemoval=true,cascade={CascadeType.PERSIST,CascadeType.ALL},fetch=FetchType.EAGER)
	...
	//// message
	@OneToMany(mappedBy = "userTransmitter",orphanRemoval=true,cascade=CascadeType.ALL)
	private List<Message> lTransmiiters;
	@OneToMany(mappedBy = "userReceiver",orphanRemoval=true,cascade=CascadeType.ALL)
